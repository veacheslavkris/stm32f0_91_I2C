#include "a_i2c.h"
  ...
  */
  ...
  #define TIMEOUT_AUTOEND_STOP	10
  #define TIMEOUT_RXNE			10
  #define TIMEOUT_NACK			10
  #define TIMEOUT_NACK_STOP		10
...
static I2CStateEnum I2C_IsAcknowledgeFailed(I2C_TypeDef* pI2C)
{
	uint32_t timout = 0;
...
I2CStateEnum HAL_I2C_Master_Receive(I2CStructHandle* pHI2C)
{
	...
	while((pHI2C->pI2C->ISR & I2C_ISR_RXNE) == 0U)
	{
		...
		if(I2C_IsAcknowledgeFailed(pHI2C->pI2C) == I2C_STATE_NACK)
		{
			return I2C_STATE_NACK;
		}
